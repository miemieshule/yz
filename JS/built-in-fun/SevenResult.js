...
// slogan 口号 、change  改 
// var onesloan = "源栈’：飞哥小班教学，线下免费收看".replace('飞哥','大神');
// var twosloan = Asloan.replace('线下','线上')
...
// var userdata = ['why','gIT','vs2019','community','VERSION'];
// stingfun(userdata);
// function stingfun(params) {

//     var newarry = [];
//     for (let i = 0; i < params.length ; i++) {
//         if (params[i].length > 6 ) {
//           var onetemp =  params[i].substring(0,6) ;
//           var twotemp =   onetemp.substring(0,1).toUpperCase() + onetemp.substring(1,6).toLowerCase() ;
//           newarry.push(twotemp)
//         }else{
//          var threetemp = params[i].substring(0,1).toUpperCase() + params[i].substring(1,6).toLowerCase()  ;
//          newarry.push(threetemp)
//         }
//     }
//     console.log(newarry);
// }
...
//  根据长度生成次数 for if判断max值，生成随机值 

// var nullarray = [];
// nullarray.length = 3 ;

// getRandomArray(nullarray , 4)
